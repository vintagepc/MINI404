...
static const stm32_soc_cfg_t stm32h503xx_cfg =
{
	...
	.perhipherals = {
		PER_LNI(P_CAN1, TYPE_STM32H503_FDCAN, H503_FDCAN1_ADDR, H503_FDCAN1_IT0_IRQ, H503_FDCAN1_IT1_IRQ),
		...
		PER_LNI(P_I2C1, TYPE_STM32H503_I2C, H503_I2C1_ADDR, H503_I2C1_EV_IRQ, H503_I2C1_ER_IRQ),
		PER_LNI(P_I2C2, TYPE_STM32H503_I2C, H503_I2C2_ADDR, H503_I2C2_EV_IRQ, H503_I2C2_ER_IRQ),
		...
		PER_LNI(P_FINT, TYPE_STM32H503_FINT, H503_FLASH_R_ADDR, H503_FLASH_IRQ),
		PER_LNA(IWDG, , H503),
		PER_LNA(CRC, ,H503),
		PER_LNA(RNG, ,H503),
		// PER_LN(P_SYSCFG, TYPE_STM32G070_SYSCFG, 0x40010000),

		PER_LN(P_OTP, TYPE_STM32H503_OTP, H503_FLASH_OTP_ADDR),
