...
static const stm32_soc_cfg_t stm32h503xx_cfg =
{
	...
	.perhipherals = {
		...
		PER_LNI(P_TIM6, 	TYPE_STM32F4XX_TIMER, 0x40001000, H503_TIM6_IRQ),
		PER_LNI(P_TIM7, 	TYPE_STM32F4XX_TIMER, 0x40001400, H503_TIM7_IRQ),
		...
		PER_LN(P_ICACHE, TYPE_STM32H503_ICACHE, 0x40030400),
