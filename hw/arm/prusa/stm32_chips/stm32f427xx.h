...
static const stm32_soc_cfg_t stm32f427xx_cfg =
{
	...
	.perhipherals = {
		...
		PER_LNI(P_USART2, TYPE_STM32_UART, 0x40004400, F4xx_USART2_IRQ),
		PER_LNI(P_USART3, TYPE_STM32_UART, 0x40004800, F4xx_USART3_IRQ),
		PER_LNI(P_USART4, TYPE_STM32_UART, 0x40004C00, F4xx_UART4_IRQ),
		PER_LNI(P_USART5, TYPE_STM32_UART, 0x40005000, F4xx_UART5_IRQ),
		PER_LNI(P_USART6, TYPE_STM32_UART, 0x40011400, F4xx_USART6_IRQ),
		PER_LNI(P_USART7, TYPE_STM32_UART, 0x40007800, F4xx_UART7_IRQ),
		PER_LNI(P_USART8, TYPE_STM32_UART, 0x40007C00, F4xx_UART8_IRQ),
