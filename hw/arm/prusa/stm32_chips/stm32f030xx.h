...
static const stm32_soc_cfg_t stm32f030xx_cfg =
{
	...
	.perhipherals = {
		PER_LNI(P_UART1, TYPE_STM32F030_USART, F030_USART1_ADDR, F030_USART1_IRQ),
		PER_LNI(P_UART2, TYPE_STM32F030_USART, F030_USART2_ADDR, F030_USART2_IRQ),

		PER_LNI(P_SPI1, TYPE_STM32F030_SPI, F030_SPI1_ADDR, F030_SPI1_IRQ),
		PER_LNI(P_SPI2, TYPE_STM32F030_SPI, F030_SPI2_ADDR, F030_SPI2_IRQ),

		PER_LN(P_GPIOA, TYPE_STM32F030_GPIO, F030_GPIOA_ADDR),
		PER_LN(P_GPIOB, TYPE_STM32F030_GPIO, F030_GPIOB_ADDR),
		PER_LN(P_GPIOC, TYPE_STM32F030_GPIO, F030_GPIOC_ADDR),
		PER_LN(P_GPIOD, TYPE_STM32F030_GPIO, F030_GPIOD_ADDR),
		PER_LN(P_GPIOF, TYPE_STM32F030_GPIO, F030_GPIOF_ADDR),

		PER_LN(P_DMA1, TYPE_STM32F030_DMA, F030_DMA1_ADDR),

		PER_LN(P_SYSCFG, TYPE_STM32F030_SYSCFG, F030_SYSCFG_ADDR),
		...
		PER_LNI(P_ADC1, TYPE_STM32F030_ADC, F030_ADC1_ADDR, F030_ADC1_IRQ),
		...
		PER_LN(P_IWDG, TYPE_STM32F030_IWDG, F030_IWDG_ADDR),
		PER_LN(P_CRC, TYPE_STM32F030_CRC, F030_CRC_ADDR),

		PER_LNI(P_EXTI, TYPE_STM32F4XX_EXTI, F030_EXTI_ADDR, [0 ... 1] = F030_EXTI0_1_IRQ, [2 ... 3] = F030_EXTI2_3_IRQ, [4 ... 15] = F030_EXTI4_15_IRQ),
	}
} ;
