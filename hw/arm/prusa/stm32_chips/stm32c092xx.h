...
static const stm32_soc_cfg_t stm32c092xx_cfg =
{
	...
	.perhipherals = {
		PER_LNI(P_CAN1, TYPE_STM32C092_FDCAN, C092_FDCAN1_ADDR, C092_FDCAN1_IT0_IRQ, C092_FDCAN1_IT1_IRQ),
		PER_LNA(CRC,, C092),
		PER_LNI(P_EXTI, TYPE_STM32C092_EXTI, C092_EXTI_ADDR, [0 ... 1] = C092_EXTI0_1_IRQ, [2 ... 3] = C092_EXTI2_3_IRQ, [4 ... 15] = C092_EXTI4_15_IRQ),
		PER_LNI(P_FINT, TYPE_STM32C092_FINT, C092_FLASH_R_ADDR, C092_FLASH_IRQ),
