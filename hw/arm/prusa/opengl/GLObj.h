...
#include "../3rdParty/tinyobjloader/tiny_obj_loader.h"  // for material_t
...
class GLObj
{
    public:
        ...
        void GetCenteringTransform(gsl::span<float> fTrans) { 
            for (int i=0; i<3; i++) fTrans[i] = -0.5f * ((m_extMin[i] + m_extMax[i]));
