...
bool Scriptable::RegisterAction(const std::string &strAct, const std::string& strDesc, unsigned int ID)
{
...
bool Scriptable::RegisterActionAndMenu(const std::string &strAct, const std::string& strDesc, unsigned int ID)
{
...
void Scriptable::RegisterMenu(const std::string &strLabel, unsigned uiID)
{
