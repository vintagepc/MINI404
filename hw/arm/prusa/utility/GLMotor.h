...
class GLMotor
{
    friend GLDashboardMgr;
	public:
		// Default constructor.
		explicit GLMotor(char cAxis = ' ', bool bSimple = false):m_bIsSimple(bSimple),m_cAxis(cAxis){};
	...
	protected:
		...
		inline void SetStall(bool bVal) { m_bStall = bVal; }
	...
	private:
		...
		std::atomic_bool m_bEnable {false}, m_bIsSimple{false}, m_bStall {false};
